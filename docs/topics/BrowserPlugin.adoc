...
3. Click the _Enable browser integration_ checkbox *(A)*. Then select the browsers for which you have downloaded the KeePassXC-Browser extension *(B)* and click *OK*.
